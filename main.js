...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('[AJUSER BOT]'), color('𝘿𝙊𝙋𝙀 𝙇𝙐𝙁𝘼 𝘽𝙊𝙏 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
